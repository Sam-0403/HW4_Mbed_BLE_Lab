...
public:
     ...
     */
    // HeartRateService(BLE &_ble, uint16_t hrmCounter, BodySensorLocation location, int16_t* magCounter) :
    HeartRateService(BLE &_ble, uint16_t hrmCounter, BodySensorLocation location) :
        ...
        // magXRate(
        //     GattCharacteristic::UUID_MAG_X_RATE_MEASUREMENT_CHAR,
        ...
        // ),
        // magYRate(
        //     GattCharacteristic::UUID_MAG_Y_RATE_MEASUREMENT_CHAR,
        ...
        // ),
        // magZRate(
        //     GattCharacteristic::UUID_MAG_Z_RATE_MEASUREMENT_CHAR,
    ...
    void updateSensorRate(uint16_t hrmCounter, int16_t* magCounter) {
        valueBytes.updateHeartRate(hrmCounter);
        // valueXBytes.updateMagRate(magCounter[0]);
        // valueYBytes.updateMagRate(magCounter[1]);
        // valueZBytes.updateMagRate(magCounter[2]);
        ble.gattServer().write(
            hrmRate.getValueHandle(),
            valueBytes.getPointer(),
            valueBytes.getNumValueBytes()
...
protected:
    ...
    void setupService() {
        ...
        // GattCharacteristic *magCharTable[] = {
        //     &magXRate,
        //     &magYRate,
        //     &magZRate
        // };
        // GattService magService(
        //     GattService::UUID_MAG_SENSOR_SERVICE,
        //     magCharTable,
        //     sizeof(magCharTable) / sizeof(magCharTable[0])
        // );
...
protected:
    ...
    //     void updateMagRate(int16_t magCounter)
    //     {
    //         uint16_t u_magCounter = magCounter+32768;
    //         if (u_magCounter <= 255) {
    //             valueBytes[FLAGS_BYTE_INDEX] &= ~VALUE_FORMAT_FLAG;
    //             valueBytes[FLAGS_BYTE_INDEX + 1] = u_magCounter;
    //         } else {
    //             valueBytes[FLAGS_BYTE_INDEX] |= VALUE_FORMAT_FLAG;
    //             valueBytes[FLAGS_BYTE_INDEX + 1] = (uint8_t)(u_magCounter & 0xFF);
    //             valueBytes[FLAGS_BYTE_INDEX + 2] = (uint8_t)(u_magCounter >> 8);
    //         }
    //     }
